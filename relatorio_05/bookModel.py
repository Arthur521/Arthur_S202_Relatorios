...
class BookModel:
    ...
    def create_book(self, id: int, titulo: str, autor: str, ano: int, preco: str):
        try:
    ...
    def update_book(self, id: str, nome: str, titulo: str, autor: str, ano: int, preco: str):
        try:
            res = self.db.collection.update_one({"_id": ObjectId(id)}, {"$set": {"_id": id, "titulo": titulo, "autor": autor, "ano": ano, "preco": preco}})
